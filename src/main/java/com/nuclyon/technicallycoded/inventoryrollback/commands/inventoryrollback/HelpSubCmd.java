    ...
    public void sendHelp(CommandSender sender) {
        sender.sendMessage(
                MessageData.getPluginPrefix() + ChatColor.GRAY + "InventoryRollbackPlus - by TechnicallyCoded\n" +
                        ...
                        ChatColor.WHITE + "    /irp forcebackup <all/player> [player]" + ChatColor.GRAY + " - Create a forced save of a player's inventory. The confirmation is only sent once the backup is on disk\n" +
